...
import { PlayCircle, ChevronRight, BarChart2, Smartphone, Shield, Users, Zap, Award, ArrowRight, X } from 'lucide-react';
...
export default function LandingPage() {
  ...
  // Inline CSS for the logo marquee
  useEffect(() => {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh', background: 'transparent', overflowX: 'hidden', fontFamily: "'Inter', sans-serif" }}>
      ...
      <header style={{ 
        ...
        <div style={{ display: 'flex', gap: '16px', alignItems: 'center' }}>
          <button style={{ 
            ...
            fontSize: '0.85rem', fontWeight: 700, cursor: 'pointer', transition: 'color 0.2s'
      ...
      <AnimatePresence>
        {showLoginModal && (
          <motion.div 
            ...
            style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, zIndex: 1000, display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'rgba(0,0,0,0.6)', backdropFilter: 'blur(8px)' }}
          >
            <motion.div 
      ...
      <section style={{ 
        ...
        padding: '120px 48px 40px 48px', overflow: 'hidden' 
      }}>
        ...
        <div style={{ display: 'flex', width: '100%', maxWidth: '1400px', margin: '0 auto', zIndex: 10 }}>
          <div style={{ flex: 1, paddingRight: '40px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              ...
              <h1 style={{ 
                fontFamily: "'Poppins', sans-serif", fontSize: '4.5rem', fontWeight: 900, lineHeight: 1.05, 
          ...
          <div style={{ flex: 1.2, display: 'flex', alignItems: 'center', justifyContent: 'center', perspective: '1200px' }}>
            <motion.div 
            ...
            {[1, 2].map((group) => (
              <div key={group} style={{ display: 'flex', justifyContent: 'space-around', width: '100%', alignItems: 'center' }}>
                {clients && clients.length > 0 ? (
                  ...
                  // Fallbacks while loading or if no clients exist
      ...
      <section id="platform" style={{ padding: '120px 48px', maxWidth: '1400px', margin: '0 auto' }}>
      ...
      <section id="features" style={{ padding: '80px 48px 120px 48px', background: 'radial-gradient(ellipse at bottom, rgba(0,240,255,0.05) 0%, transparent 70%)' }}>
        <div style={{ maxWidth: '1400px', margin: '0 auto', display: 'flex', gap: '64px', alignItems: 'center' }}>
          
          <div style={{ flex: 0.8 }}>
            <h2 style={{ fontSize: '2.5rem', fontWeight: 800, color: 'var(--text-primary)', marginBottom: '40px' }}>Discover the Platform</h2>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              {Object.keys(features).map(key => (
                <div key={key} onClick={() => setActiveFeature(key)} style={{ 
                  ...
                  <AnimatePresence>
                    {activeFeature === key && (
                      <motion.p initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: 'auto' }} exit={{ opacity: 0, height: 0 }} 
                        style={{ margin: 0, color: 'var(--text-secondary)', fontSize: '0.95rem', lineHeight: 1.6 }}>
                        {features[key].desc}
                      </motion.p>
                    )}
                  </AnimatePresence>
      ...
      {/* ── ROI IMPACT METRICS ── */}
      <section style={{ padding: '80px 48px', borderTop: '1px solid rgba(255,255,255,0.05)', borderBottom: '1px solid rgba(255,255,255,0.05)', background: 'rgba(0,0,0,0.3)' }}>
      ...
      <section style={{ padding: '120px 48px', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative', zIndex: 10, maxWidth: '600px', margin: '0 auto' }}>
          <h2 style={{ fontSize: '3rem', fontWeight: 900, color: 'var(--text-primary)', marginBottom: '24px' }}>Ready to Transform?</h2>
      ...
      {/* ── FOOTER ── */}
      <footer style={{ borderTop: '1px solid rgba(255,255,255,0.05)', padding: '40px 48px', display: 'flex', justifyContent: 'space-between', color: 'var(--text-muted)', fontSize: '0.85rem' }}>
...
console.log('Successfully refactored LandingPage.jsx');

...
export default function PMDashboardView({
  ...
  return (
    <div style={{ fontFamily: "'Inter', sans-serif", color: 'var(--text-primary)', padding: '8px 0' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '16px', marginBottom: '24px' }}>
        {[
          { 
            ...
            col: 'var(--primary)',
            icon: <FolderOpen size={18} color='var(--primary)' />,
            sparkline: (
              <svg viewBox="0 0 80 25" style={{ width: '70px', height: '20px' }}>
                <path d="M 0 20 Q 20 18 40 10 T 60 15 T 80 5" fill="none" stroke='var(--primary)' strokeWidth="2" />
              </svg>
            )
          },
          { 
          ...
          <div key={i} className="glass-card" style={{
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginTop: '8px' }}>
              <div>
                <div style={{ fontSize: '1.4rem', fontWeight: 800, color: 'var(--text-primary)', fontFamily: "'Poppins', sans-serif" }}>{card.val}</div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 350px), 1fr))', gap: '20px', marginBottom: '24px' }}>
        ...
        <div className="glass-card" style={{ background: 'var(--bg-glass)', padding: '24px', borderRadius: '20px', border: '1px solid #B7BEC7', display: 'flex', flexDirection: 'column', justifyContent: 'space-between',  }}>
          <div>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
              ...
              <select style={{ padding: '4px 8px', borderRadius: '6px', border: '1px solid #B7BEC7', fontSize: '0.75rem', fontWeight: 600, background: 'var(--bg-tertiary)' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '12px', marginTop: '16px' }}>
              ...
              <div style={{ position: 'relative', width: '110px', height: '110px', flexShrink: 0 }}>
                <svg viewBox="0 0 36 36" style={{ transform: 'rotate(-90deg)', width: '100%', height: '100%' }}>
                  <circle cx="18" cy="18" r="15.915" fill="none" stroke='var(--border-glass)' strokeWidth="3.5" />
                  {/* Completed: 33% */}
                  <circle cx="18" cy="18" r="15.915" fill="none" stroke="#3B8C68" strokeWidth="3.5" strokeDasharray="33 67" strokeDashoffset="0" />
                  {/* Upcoming: 22% */}
                  <circle cx="18" cy="18" r="15.915" fill="none" stroke='var(--primary)' strokeWidth="3.5" strokeDasharray="22 78" strokeDashoffset="-33" />
                  {/* Active: 22% */}
                ...
                <div style={{ position: 'absolute', inset: 0, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
                  <span style={{ fontSize: '1.25rem', fontWeight: 900, color: 'var(--text-primary)' }}>9</span>
                  <span style={{ fontSize: '0.55rem', color: 'var(--text-secondary)', fontWeight: 700, textTransform: 'uppercase' }}>Total</span>
                </div>
              </div>
              ...
              <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '6px' }}>
                {[
                  { label: 'Upcoming', count: 2, pct: '22%', col: 'var(--primary)' },
          ...
          <button style={{ marginTop: '20px', width: '100%', padding: '10px', background: 'var(--bg-tertiary)', border: '1px solid #B7BEC7', borderRadius: '10px', fontSize: '0.78rem', fontWeight: 700, color: 'var(--primary)', cursor: 'pointer', transition: 'all 0.2s' }} onMouseOver={e => e.currentTarget.style.background = '#EEF2F7'} onMouseOut={e => e.currentTarget.style.background = 'var(--bg-tertiary)'}>
        ...
        <div className="glass-card" style={{ background: 'var(--bg-glass)', padding: '24px', borderRadius: '20px', border: '1px solid #B7BEC7', display: 'flex', flexDirection: 'column', justifyContent: 'space-between',  }}>
          <div>
            ...
            <div style={{ height: '110px', marginTop: '16px' }}>
              ...
              <svg viewBox="0 0 280 100" style={{ width: '100%', height: '100%', overflow: 'visible' }}>
                {/* Grid Lines */}
                <line x1="0" y1="20" x2="280" y2="20" stroke="var(--bg-tertiary)" strokeWidth="1" />
                <line x1="0" y1="50" x2="280" y2="50" stroke="var(--bg-tertiary)" strokeWidth="1" />
                <line x1="0" y1="80" x2="280" y2="80" stroke="var(--bg-tertiary)" strokeWidth="1" />
                
                {/* Completion line (Blue) */}
                <polyline fill="none" stroke='var(--primary)' strokeWidth="2" points="10,55  60,55  110,38  160,48  210,32  260,18" />
                {/* Assessment line (Green) */}
                <polyline fill="none" stroke="#3B8C68" strokeWidth="2" points="10,75  60,70  110,65  160,58  210,50  260,42" />
                
                {/* Dots */}
                <circle cx="260" cy="18" r="3" fill='var(--primary)' />
          ...
          <div style={{ display: 'flex', gap: '12px', marginTop: '16px', background: 'var(--bg-tertiary)', padding: '10px 14px', borderRadius: '10px', border: '1px solid #B7BEC7' }}>
            <div style={{ flex: 1, display: 'flex', alignItems: 'center', gap: '8px' }}>
              <span style={{ width: '8px', height: '8px', background: 'var(--primary)', borderRadius: '2px' }} />
              <div style={{ fontSize: '0.7rem', color: 'var(--text-secondary)' }}>Completion %: <strong style={{ color: 'var(--text-primary)', fontSize: '0.8rem' }}>91%</strong></div>
            </div>
            <div style={{ flex: 1, display: 'flex', alignItems: 'center', gap: '8px' }}>
              <span style={{ width: '8px', height: '8px', background: '#3B8C68', borderRadius: '2px' }} />
              <div style={{ fontSize: '0.7rem', color: 'var(--text-secondary)' }}>Assessment Score: <strong style={{ color: 'var(--text-primary)', fontSize: '0.8rem' }}>72%</strong></div>
            </div>
          </div>
        </div>
        ...
        <div className="glass-card" style={{ background: 'var(--bg-glass)', padding: '24px', borderRadius: '20px', border: '1px solid #B7BEC7', display: 'flex', flexDirection: 'column', justifyContent: 'space-between',  }}>
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '16px' }}>
              ...
              <span style={{ fontSize: '0.62rem', background: 'rgba(59, 130, 246, 0.15)', color: 'var(--primary)', padding: '2px 6px', borderRadius: '6px', fontWeight: 800 }}>NEW</span>
            </div>
            
            <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
              {[
                { text: 'Compliance index is below 60% in 2 subprojects.', col: 'var(--primary)', bg: 'rgba(59, 130, 246, 0.15)' },
                { text: 'South region trainers need performance support. Rating < 3.8.', col: '#EF4444', bg: 'rgba(239, 68, 68, 0.2)' },
                { text: 'Certification pass rate improved by 12%. Keep going!', col: '#3B8C68', bg: 'rgba(34, 197, 94, 0.2)' },
                { text: '4 learners are at risk of non-completion.', col: '#F97316', bg: '#FFEDD5' }
              ].map((ins, idx) => (
                <div key={idx} style={{ 
                  display: 'flex', alignItems: 'center', justifyContent: 'space-between',
                  padding: '10px 12px', background: 'var(--bg-tertiary)', borderRadius: '10px', border: '1px solid #B7BEC7', cursor: 'pointer'
                }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                    ...
                    <span style={{ fontSize: '0.72rem', fontWeight: 600, color: 'var(--text-secondary)', lineHeight: '1.3' }}>{ins.text}</span>
                  </div>
          ...
          <button style={{ marginTop: '14px', width: '100%', padding: '10px', background: 'var(--bg-tertiary)', border: '1px solid #B7BEC7', borderRadius: '10px', fontSize: '0.78rem', fontWeight: 700, color: 'var(--primary)', cursor: 'pointer', transition: 'all 0.2s' }} onMouseOver={e => e.currentTarget.style.background = '#EEF2F7'} onMouseOut={e => e.currentTarget.style.background = 'var(--bg-tertiary)'}>
            View All Insights
          </button>
        </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 280px), 1fr))', gap: '20px', marginBottom: '32px' }}>
        ...
        <div className="glass-card" style={{ background: 'var(--bg-glass)', padding: '20px', borderRadius: '20px', border: '1px solid #B7BEC7', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
          <div>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
              <h4 style={{ margin: 0, fontSize: '0.92rem', fontWeight: 800, fontFamily: "'Poppins', sans-serif" }}>Trainer Performance</h4>
              <a href="#trainers" style={{ fontSize: '0.72rem', color: 'var(--primary)', fontWeight: 700, textDecoration: 'none' }}>View All</a>
            </div>
            
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.72rem' }}>
              <thead>
                <tr style={{ borderBottom: '1px solid #B7BEC7', textAlign: 'left', color: 'var(--text-secondary)', fontWeight: 700 }}>
              ...
              <tbody>
                {[
                  { name: 'Rajiv Sharma', s: 12, score: '84%', rating: '4.6/5', col: '#3B8C68', bg: 'rgba(34, 197, 94, 0.2)' },
                  { name: 'Neha Verma', s: 8, score: '76%', rating: '4.2/5', col: '#3B8C68', bg: 'rgba(34, 197, 94, 0.2)' },
                  ...
                  <tr key={idx} style={{ borderBottom: '1px solid var(--bg-tertiary)' }}>
                    ...
                    <td style={{ padding: '8px 0', textAlign: 'center', color: 'var(--text-secondary)' }}>{tr.s}</td>
        ...
        <div className="glass-card" style={{ background: 'var(--bg-glass)', padding: '20px', borderRadius: '20px', border: '1px solid #B7BEC7', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
          <div>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px' }}>
              ...
              <select value={regionFilter} onChange={e => setRegionFilter(e.target.value)} style={{ padding: '2px 6px', borderRadius: '4px', border: '1px solid #B7BEC7', fontSize: '0.72rem', background: 'var(--bg-tertiary)' }}>
                ...
                {[
                  ...
                  <div key={idx} style={{ display: 'flex', flexDirection: 'column', gap: '2px' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.68rem', fontWeight: 700 }}>
                      <span style={{ color: 'var(--text-secondary)' }}>{reg.label}</span>
                      <span style={{ color: reg.col }}>{reg.pct}</span>
                    </div>
                    <div style={{ height: '5px', background: 'var(--bg-tertiary)', borderRadius: '4px', overflow: 'hidden' }}>
          ...
          <button style={{ marginTop: '10px', width: '100%', padding: '6px', background: 'var(--bg-tertiary)', border: '1px solid #B7BEC7', borderRadius: '6px', fontSize: '0.72rem', fontWeight: 700, color: 'var(--primary)', cursor: 'pointer', transition: 'all 0.2s' }} onMouseOver={e => e.currentTarget.style.background = '#EEF2F7'} onMouseOut={e => e.currentTarget.style.background = 'var(--bg-tertiary)'}>
        ...
        <div className="glass-card" style={{ background: 'var(--bg-glass)', padding: '20px', borderRadius: '20px', border: '1px solid #B7BEC7', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
          <div>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px' }}>
              ...
              <select style={{ padding: '2px 6px', borderRadius: '4px', border: '1px solid #B7BEC7', fontSize: '0.72rem', background: 'var(--bg-tertiary)' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '8px' }}>
              ...
              <div style={{ position: 'relative', width: '80px', height: '80px', flexShrink: 0 }}>
                <svg viewBox="0 0 36 36" style={{ transform: 'rotate(-90deg)', width: '100%', height: '100%' }}>
                  <circle cx="18" cy="18" r="15.915" fill="none" stroke='var(--border-glass)' strokeWidth="4" />
                  {/* Completed: 58% */}
                ...
                <div style={{ position: 'absolute', inset: 0, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
                  <span style={{ fontSize: '1.1rem', fontWeight: 900, color: 'var(--text-primary)' }}>58%</span>
                </div>
              </div>
        ...
        <div className="glass-card" style={{ background: 'var(--bg-glass)', padding: '20px', borderRadius: '20px', border: '1px solid #B7BEC7', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
              {[
                { name: 'Create New Subproject', icon: <Plus size={12} />, bg: 'rgba(59, 130, 246, 0.15)', col: 'var(--primary)' },
                ...
                { name: 'Generate PM Report', icon: <FileText size={12} />, bg: 'rgba(234, 88, 12, 0.15)', col: '#C2410C' },
                { name: 'Send Notification', icon: <Send size={12} />, bg: 'rgba(239, 68, 68, 0.2)', col: '#B91C1C' }
              ].map((act, idx) => (
                <button key={idx} onClick={() => handleQuickAction(act.name)} style={{
                  ...
                  background: 'var(--bg-tertiary)', border: '1px solid #B7BEC7', cursor: 'pointer', textAlign: 'left', transition: 'all 0.18s'
                }} onMouseOver={e => { e.currentTarget.style.background = act.bg; e.currentTarget.style.borderColor = act.col; }} onMouseOut={e => { e.currentTarget.style.background = 'var(--bg-tertiary)'; e.currentTarget.style.borderColor = 'var(--border-glass)'; }}>
                  ...
                  <span style={{ fontSize: '0.72rem', fontWeight: 700, color: 'var(--text-secondary)' }}>{act.name}</span>
                </button>
              ))}
            </div>
          </div>
      ...
      <div className="glass-card" style={{ background: 'var(--bg-glass)', padding: '24px', borderRadius: '24px', border: '1px solid #B7BEC7',  }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
          <div>
            ...
            <p style={{ margin: '2px 0 0 0', fontSize: '0.78rem', color: 'var(--text-secondary)' }}>Real-time progress overview across your program scope.</p>
          </div>
          <span onClick={() => navigate('/projects')} style={{ fontSize: '0.82rem', color: 'var(--primary)', fontWeight: 700, cursor: 'pointer' }}>View All</span>
        </div>

        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 220px), 1fr))', gap: '16px' }}>
          {[
            { name: 'Q2 Field Force Training', desc: 'Retail Excellence Program', date: '10 Jun 2026', lCount: 12, pct: '65%', status: 'Active', col: '#3B8C68', bg: 'rgba(34, 197, 94, 0.2)' },
            { name: 'Unilever Execution Training', desc: 'Execution & Compliance', date: '12 Jun 2026', lCount: 10, pct: '40%', status: 'Active', col: '#3B8C68', bg: 'rgba(34, 197, 94, 0.2)' },
            { name: 'Beyond Audit Readiness', desc: 'Compliance Program', date: '08 Jun 2026', lCount: 8, pct: '25%', status: 'Delayed', col: '#F97316', bg: '#FFEDD5' },
            { name: 'Q1 RTI Drive', desc: 'Retail Transformation Initiative', date: '02 Jun 2026', lCount: 15, pct: '100%', status: 'Completed', col: 'var(--text-primary)', bg: 'var(--bg-tertiary)' },
            { name: 'Safety & Compliance', desc: 'Safety Training Program', date: '15 Jun 2026', lCount: 6, pct: '10%', status: 'On Hold', col: '#727A86', bg: 'var(--bg-tertiary)' }
          ].map((proj, idx) => (
            <div key={idx} style={{
              ...
              <div>
                ...
                <h5 style={{ margin: '0 0 4px 0', fontSize: '0.82rem', fontWeight: 800, color: 'var(--text-primary)', fontFamily: "'Poppins', sans-serif", lineHeight: '1.3' }}>{proj.name}</h5>
                <span style={{ fontSize: '0.68rem', color: 'var(--text-secondary)' }}>{proj.desc}</span>
              </div>
              ...
              <div style={{ marginTop: '12px' }}>
                ...
                <div style={{ height: '6px', background: 'var(--border-glass)', borderRadius: '4px', overflow: 'hidden' }}>
                  <div style={{ width: proj.pct, height: '100%', background: proj.status === 'Delayed' ? '#F97316' : proj.status === 'Completed' ? '#3B8C68' : 'var(--primary)', borderRadius: '4px' }} />
                </div>
